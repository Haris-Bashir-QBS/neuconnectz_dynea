...
class GrnQuantityPage extends StatelessWidget {
  final GrnQuantityPageParams params;

  const GrnQuantityPage({super.key, required this.params});

  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => sl<PutAwayBloc>()),
...
class _GrnQuantityViewState extends State<_GrnQuantityView> {
  ...
  Widget _proceedButton() {
    final bloc = context.watch<PutAwayBloc>();
    ...
    return CustomButton(
      ...
      onPressed: () async {
        ...
        final request = CreatePutAwayRequestModel.fromEntities(
