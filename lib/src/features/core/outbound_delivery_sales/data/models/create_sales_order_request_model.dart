...
class CreateSalesOrderRequestModel {
  ...
  factory CreateSalesOrderRequestModel.fromEntities({
    required OutboundDeliverySalesItemEntity item,
    ...
    return CreateSalesOrderRequestModel(
      selectedPlant: selectedPlant,
      selectedWarehouse: selectedWarehouse,
      deliveryNo: item.delivery,
      deliveryItemNo: item.item.toString(),
      salesUom: item.salesUnit.isNotEmpty ? item.salesUnit : item.baseUom,
