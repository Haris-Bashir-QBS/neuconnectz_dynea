...
class OutboundDeliveryStoCard extends StatelessWidget {
  final OutboundDeliveryStoEntity item;
  final VoidCallback? onTap;

  const OutboundDeliveryStoCard({super.key, required this.item, this.onTap});
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8.h),
                  _detailRow('Receiving Plant: ${item.receivingPlant}'),
                  SizedBox(height: 4.h),
