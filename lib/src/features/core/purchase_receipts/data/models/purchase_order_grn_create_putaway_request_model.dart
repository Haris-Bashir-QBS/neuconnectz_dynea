...
class CreatePurchaseOrderGrnPutAwayRequestModel {
  ...
  CreatePurchaseOrderGrnPutAwayRequestModel({
  ...
  factory CreatePurchaseOrderGrnPutAwayRequestModel.fromEntities({
    required PurchaseOrderGrnEntity grn,
    required PurchaseOrderGrnItemEntity item,
    ...
    return CreatePurchaseOrderGrnPutAwayRequestModel(
