...
class PurchaseOrderGrnListResponseModel {
  ...
  PurchaseOrderGrnListResponseModel({
  ...
  factory PurchaseOrderGrnListResponseModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return PurchaseOrderGrnListResponseModel(
...
class GrnListItemModel {
  ...
  PurchaseOrderGrnEntity toEntity() => PurchaseOrderGrnEntity(
