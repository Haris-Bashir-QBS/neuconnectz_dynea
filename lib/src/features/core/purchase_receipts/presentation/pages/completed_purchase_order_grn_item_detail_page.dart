...
class CompletedPurchaseOrderGrnItemDetailPage extends StatelessWidget {
  final PurchaseOrderGrnItemEntity item;

  const CompletedPurchaseOrderGrnItemDetailPage({
    super.key,
    required this.item,
  });
  ...
  Widget _binDetailTile(PurchaseOrderGrnItemBinDetailEntity bin) {
    return Padding(
