...
class CustomBottomBarItem<T> {
  final T icon;

  final String label;

  CustomBottomBarItem({required this.icon, required this.label})
    : assert(
...
class CustomLineIndicatorBottomNavbarItems extends StatelessWidget {
    ...
    return SafeArea(
      child: Material(
        ...
        child: InkWell(
          ...
          child: _bottomBarArea(bottomTheme, context),
        ),
      ),
    );
  }

  Widget _bottomBarArea(
    BottomNavigationBarThemeData bottomTheme,
    BuildContext context,
  ) {
    return Container(
      decoration: BoxDecoration(
        border: enableLineIndicator ? _borderIndicator(bottomTheme) : null,
      ),
  ...
  Border _borderIndicator(BottomNavigationBarThemeData bottomTheme) {
    return Border(
      bottom:
  ...
  Widget iconWidget(BottomNavigationBarThemeData bottomTheme) {
