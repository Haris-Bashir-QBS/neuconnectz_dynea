...
class BarcodeScannerViewController: UIViewController {
    ...
    private func setConstraintsForControls() {
        let buttonTopPadding: CGFloat = 30 // Adjust this value for desired padding from the safe area top
        ...
        flashIcon.topAnchor.constraint(equalTo: safeArea.topAnchor, constant: buttonTopPadding).isActive = true
        ...
        cancelButton.topAnchor.constraint(equalTo: safeArea.topAnchor, constant: buttonTopPadding).isActive=true
        ...
        switchCameraButton.topAnchor.constraint(equalTo: safeArea.topAnchor, constant: buttonTopPadding).isActive = true
    }
